...
L'accertamento dell'edizione di AKABAK, che è piccolo e non blocca nulla ma non va perso: la finestra del release code non dichiara l'edizione, la barra del titolo riporta `32 Professional`, e le osservazioni del 2026-09-07 su cui poggiano tre pagine riportavano `Standard Edition`. Si chiude aprendo la finestra di informazioni sul programma con la barra del titolo visibile nello stesso fotogramma.
