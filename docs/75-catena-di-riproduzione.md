...
Sul primo anello della catena esiste una fonte tecnica propria, esterna a questo repository e non citata dalle versioni precedenti di questa pagina: il progetto `rodrainaudio-reverse-eng` contiene una trattazione di analisi ingegneristica del DAC Rod Rain basato su ES9023, con le proprie figure e i propri riferimenti. È la sede dove il comportamento reale della sorgente è documentato, e va consultata prima di assumere qualunque cosa sul suo livello di uscita o sulla sua impedenza: il valore che questa pagina riporta, cioè l'uscita di linea su RCA a 2 Vrms, viene da ADR-012 e va confrontato con quella trattazione quando la fase di caratterizzazione si apre.

La seconda è più sottile e riguarda la validità delle misure. La catena di *misura* richiede un ingresso microfonico con alimentazione phantom, che la scheda integrata della macchina non ha e che nessuna interfaccia oggi presente fornisce, mentre la catena di *ascolto* userà il Rod Rain. Quale interfaccia serva alla misura è una decisione aperta, tracciata in PA-012 con i due vincoli fissati dall'utente; le versioni precedenti di questa pagina nominavano una Focusrite Scarlett 2i2 come già disponibile, e il ritiro di quella affermazione è in MS-079 con l'emendamento in ADR-018. Sono due convertitori diversi con due uscite diverse. Per la fase 1, cioè la caratterizzazione della stanza, questo è irrilevante: si misura come la stanza risponde, e la sorgente è uno strumento provvisorio. Per la fase 8, cioè la verifica finale del monitor costruito, non è irrilevante: se si vuole misurare ciò che si ascolterà, il segnale di prova deve uscire dalla catena di ascolto reale. REW permette di usare dispositivi diversi in ingresso e in uscita, quindi la configurazione corretta per la fase 8 è microfono sulla Scarlett e generazione del segnale sul Rod Rain.
