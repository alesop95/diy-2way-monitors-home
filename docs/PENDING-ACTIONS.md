...
Un dato da verificare e non da credere, marcato come tale. Per quanto risulta, Samsung non monta un sensore di profondità dedicato sui propri flagship dalla serie S20 Ultra in poi, quindi questo dispositivo dovrebbe operare interamente in software tramite l'interfaccia di profondità di ARCore. La verifica costa trenta secondi e si fa sul dispositivo, installando una applicazione di scansione e guardando se offra una modalità basata su sensore, che non dovrebbe esserci, oppure la sola modalità basata sulla fotocamera. Finché quella verifica non è fatta, l'affermazione resta una inferenza.
