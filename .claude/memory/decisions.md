...
Decisione. Su Ubuntu 26.04 questo progetto usa i pacchetti Wine della distribuzione e non quelli di WineHQ, e la raccomandazione contraria che compare nella documentazione precedente va letta come superata per questa versione del sistema operativo. La scelta non è una preferenza fra due fornitori possibili: è l'unico fornitore possibile.
