...
| roadmap.md | d8ebf45 | aggiornata il 2026-09-10: priorità riscritte, due ipotesi risolte, direzioni future |
| current-work.md | d8ebf45 | aggiornata il 2026-09-10 |
...
Resta un accertamento aperto e piccolo, l'edizione di AKABAK: la finestra del release code non la dichiara, la barra del titolo riporta `32 Professional`, e le osservazioni del 2026-09-07 su cui poggiano tre pagine riportavano `Standard Edition`. Si chiude aprendo la finestra di informazioni sul programma con la barra del titolo visibile nello stesso fotogramma.
