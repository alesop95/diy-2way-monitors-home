...
Il prossimo passo è una decisione dell'utente e non un comando: riconfermare o rivedere la scelta fra installazione pulita e aggiornamento in posto, tracciata come PA-006, perché la verifica ha fatto cadere uno dei quattro motivi su cui era stata presa. In parallelo restano le tre voci privilegiate della fase 0, tracciate come PA-005, di cui la più importante è lo stato di salute dell'SSD: è la sola che potrebbe cambiare la decisione da installazione a sostituzione del disco. Subito dopo, eseguire la fase 0 della stessa procedura: la fotografia completa della macchina in quattordici file, che è il prerequisito di tutto il resto e che conferma o smentisce la diagnosi del blocco di aggiornamento.
