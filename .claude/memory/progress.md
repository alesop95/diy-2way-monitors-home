...
Stato dei fronti a fine giornata. La procedura di installazione pulita è chiusa in tutte e dodici le sue fasi, e PA-017 è compiuta. Il fronte successivo è PA-018, cioè che fare del repository WineHQ rimasto sulla macchina, che sono due comandi privilegiati e una decisione, e PA-019, cioè la verifica della catena audio dalla console, che richiede la presenza fisica. Restano PA-016 sui due punti residui del riallineamento al template, e la fase 6 bloccata da PA-012, che è un acquisto e non lavoro.
