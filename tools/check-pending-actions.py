...
def controlla_pa010_pa011() -> None:
    ...
    archivio = Path("J:/backup-macchine/alessio-ubuntustudio/"
                    "backup-file-sistema_2026-09-17T154511.vbk")
    riga("ok" if (dest_presente and archivio.exists()) else "  ",
         "archivio del 2026-09-17 presente su J:, 17627570176 byte, MS-135")
    print("  COMPIUTA il 2026-09-17. Prodotto scelto: Veeam Agent for Linux,")
    print("  variante senza modulo del kernel, a livello di file, perche' su")
    print("  partizioni semplici il livello di volume non e' disponibile:")
    print("  MS-120, MS-121 e MS-122 lo accertano per misura.")
    print("  Prova di ripristino eseguita e non rimandata: punto montato, sei")
    print("  impronte confrontate e quattro conteggi coincidenti, MS-132.")
    print("  Archivio trasferito su J: e verificato per impronta alle due")
    print("  estremita', MS-135. Un backup mai riletto sarebbe una speranza.")
    print("  Resta provvisoria la destinazione: il NAS domestico la sostituira',")
    print("  e con essa va ripresa la decisione sulla cifratura, qui rinviata")
    print("  con motivazione. Non da' una immagine avviabile: quella resta")
...
def controlla_voci_recenti() -> None:
    ...
    riga("ok", "re-istanziazione di git-identity-and-repo.md sul quarto asse, MS-163")
    riga("ok", "decisione su hooks-starter presa: istanziato, quattro hook su sette, MS-164")
    print("  COMPIUTA il 2026-09-22. Il quarto asse e' re-istanziato sui valori letti")
    print("  sulla postazione, e l'autorizzazione OAuth della GitHub CLI e' registrata")
    print("  fra le operazioni manuali con ambiti e pagina di revoca. Il pacchetto")
    print("  hooks-starter e' istanziato con session-context, apertura-sessione,")
    print("  md-unwrap-auto e protect-sensitive-files attivi; i tre spenti hanno il")
    print("  motivo registrato, e ciascuno dei quattro e' stato eseguito e non solo")
    print("  registrato, perche' un hook che non trova il suo strumento esce zero.")
    ...
    riga("ok", "dispositivo dichiarato: Galaxy S25 Ultra, e la via ne e' discesa")
    riga("ok", "protocollo di rilievo con le sue sei tabelle scritto, MS-158")
    riga("  ", "via della scansione abbandonata il 2026-09-22 per decisione, MS-162")
    riga("  ", "metro laser: NON acquistato, e serve alla sola tabella A")
    riga("  ", "modello a poche facce in Blender: DA COSTRUIRE")
    print("  APERTA, e dal 2026-09-22 attende un acquisto e non una verifica, come")
    print("  PA-012. La scansione era un accorciamento e non un requisito, quindi il")
    print("  rilievo torna alla quarta via, cioe' quella manuale, che il protocollo di")
    print("  docs/35-rilievo-geometrico.md copre gia' senza modifiche. Le tabelle da B")
    print("  a E si riempiono anche subito con un metro a nastro: riguardano aperture,")
    print("  materiali, arredi e punto di ascolto, che si misurano da vicino. La sola")
    print("  tabella A vuole il laser, perche' le altezze del soffitto spiovente sono")
    print("  fuori portata. Il modello si valida quando la misura della fase 1 esistera'.")
    ...
    riga("ok", "gruppi 29 e 982 nel processo wireplumber, dopo il riavvio, MS-156")
    print("  COMPIUTA il 2026-09-21 in tutti e quattro i criteri, per la parte di")
    print("  uscita. Il quarto e' stato soddisfatto dal riavvio delle 16:04: quel")
    print("  processo appartiene al gestore di servizi dell'utente, che sopravvive al")
    print("  logout grafico finche' esiste una sessione, comprese le connessioni SSH,")
    print("  quindi solo un riavvio lo rinnova. Resta igiene e non requisito.")
    print("  Due dichiarazioni al posto di due lavori, da MS-156. L'uscita analogica")
    print("  dipende da un jack occupato e non da una impostazione conservata, perche'")
    print("  nessuna preferenza di profilo e' registrata e il passaggio all'analogico")
    print("  e' selezione automatica per priorita'. E con l'interfaccia di PA-012 la")
    print("  macchina avra' due schede, quindi il dispositivo predefinito diventera'")
